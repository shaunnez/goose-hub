...
export const projectSettings = sqliteTable('project_settings', {
  ...
  implementWpEditTestLoopMaxCycles: integer('implement_wp_edit_test_loop_max_cycles'),
  implementWpBugMaxTurns: integer('implement_wp_bug_max_turns'),
  implementWpBugMaxBudgetUsd: real('implement_wp_bug_max_budget_usd'),
  implementWpFeatureMaxTurns: integer('implement_wp_feature_max_turns'),
  implementWpFeatureMaxBudgetUsd: real('implement_wp_feature_max_budget_usd'),
  implementWpComplexMaxTurns: integer('implement_wp_complex_max_turns'),
  implementWpComplexMaxBudgetUsd: real('implement_wp_complex_max_budget_usd'),
  ...
  coachPolicyEnabled: integer('coach_policy_enabled'),
  coachPolicyConsistencyThreshold: real('coach_policy_consistency_threshold'),
  coachPolicyMinLifecycles: integer('coach_policy_min_lifecycles'),
