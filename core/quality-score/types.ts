...
// from the test runner. `pipelineRunId` (M19.21 #697) ties the score row to
// the PR lifecycle generated by spec-author so merge-decision and retro can
// look up by pipeline rather than per-skill runId.
