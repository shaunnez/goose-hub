...
// that would arise if FloorLayer / SpriteLayer imported from their parent scene
// while OfficeScene imported from those layers. OfficeScene re-exports these
// for backward-compat so the React side doesn't need import-path changes.
