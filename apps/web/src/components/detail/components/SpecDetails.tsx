...
export function SpecDetails({ spec, defaultOpen = false, hideHeader = false }: SpecDetailsProps) {
  ...
  const content = (
    <div
      className={
        hideHeader ? 'flex flex-col gap-4' : 'px-4 py-4 flex flex-col gap-4 border-t border-line'
      }
    >
