...
export const EVENT_KIND_LABEL: Record<string, string> = {
  ...
  'agent.checkout-readiness': 'Checkout ready',
  ...
  'qa.workflow-started': 'QA workflow started',
  'qa.workflow-completed': 'QA workflow completed',
  'qa.workflow-failed': 'QA workflow failed',
  'qa.workflow-aborted': 'QA workflow aborted',
  'qa.preflight-started': 'QA preflight started',
  'qa.preflight-step-started': 'QA preflight step started',
  'qa.preflight-step-completed': 'QA preflight step completed',
  'qa.preflight-step-failed': 'QA preflight step failed',
  'qa.preflight-completed': 'QA preflight completed',
  ...
  'workflow.route-selected': 'Workflow route selected',
  'workflow.route-confirmed': 'Workflow route confirmed',
  'workflow.route-escalation-proposed': 'Workflow route escalation proposed',
  'workflow.route-cap-applied': 'Workflow route cap applied',
