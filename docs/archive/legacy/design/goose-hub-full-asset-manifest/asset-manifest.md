...
- [x] floor_tile_01.png
- [x] floor_tile_02.png
- [x] corridor_tile_01.png
- [x] corridor_tile_02.png
- [x] floor_shadow_edge.png
- [x] carpet_trim_horizontal.png
- [x] carpet_trim_vertical.png
...
- [x] room_label_done.png
- [x] room_label_archive.png
